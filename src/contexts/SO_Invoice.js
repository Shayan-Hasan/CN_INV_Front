import { GetInvoiceProdBySoId, GetInvoiceDetailBySoId } from "../api/Api";
import html2pdf from "html2pdf.js";
import "jspdf-autotable";
// import helloImage from "./InvoiceReport/hello.jpg";
import Invoice from "../pages/SOInvoice";
...
const openNewTab = async (so_id) => {
  try {
    ...
    fd.shipping_address = [];
    fd.invoice_no = "";
    const result = await GetInvoiceProdBySoId(so_id);
    const result1 = await GetInvoiceDetailBySoId(so_id);
    ...
    fd.invoice_no = "I" + result1.data[0].invoice_id;
    ...
    tableData.push(["", "", "", "", ""]);
    var ab = subtotal + taxx1 - distotal;
    tableData.push([
      "",
      "",
      "",
